...
class IncichConn:
    ...
    def __init__(self, ip, port, sn):
        ...
        sock.send(packet_start + "25000000" + packet_sep_1 + "23333333333333" + packet_sep_2_heartbeat + sn.encode("ascii").hex() + packet_end)
        data = sock.recv()
    ...
    def send(self, content, heartbeat):
        ...
        packet_body = packet_sep_1 + self.get_packet_time() + sep_2 + content.encode("utf-8").hex() + packet_end
